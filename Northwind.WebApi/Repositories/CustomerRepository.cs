...
public class CustomerRepository
{
    ...
    //Use an instance data context field because it should not be cached due the data context having internal caching.
    private NorthwindContext db;
    public CustomerRepository(NorthwindContext injectedContext)
    {
        db = injectedContext;
        //Pre-load customers from database as a normal Dictionary with CustomerID as the key, then convert to a thread-safe ConcurrentDictionary.
